...
import Task from './components/Chat';
export default function App() {
  ...
  return (
    ...
    <View style={styles.container}>
      ...
      >
        <TextInput style={styles.input} placeholder={'Type Something....'} value={task} onChangeText={text => setTask(text)} />
        <TouchableOpacity onPress={() => handleAddTask()}>
          <View style={styles.addWrapper}>
            <Text style={styles.addText}>Send ☑️</Text>
          </View>
        </TouchableOpacity>
      </KeyboardAvoidingView>
